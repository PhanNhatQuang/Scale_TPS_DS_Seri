    ...
    public static class Excel_Export
    {
        public static void Export(DataTable dt, string sheetName, string title)
        {
            ...
            try
            {
                ...
                cl2.Value2 = "Tên mặt hàng";

                cl2.ColumnWidth = 25.0;

                Microsoft.Office.Interop.Excel.Range cl3 = oSheet.get_Range("C3", "C3");

                cl3.Value2 = "Giá trị cân";
                ...
                //Microsoft.Office.Interop.Excel.Range c11 = (Microsoft.Office.Interop.Excel.Range)oSheet.Cells[5, 4];
                ...
                Microsoft.Office.Interop.Excel.Range date = (Microsoft.Office.Interop.Excel.Range)oSheet.Cells[rowEnd, columnEnd-1];
                date.EntireColumn.NumberFormat = "M/d/yyyy h:mm:ss";
                // Kẻ viền
